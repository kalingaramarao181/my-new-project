...
const PasswordUpdate = ({isOpenUpdatedPopup, closeUpdatadPopup}) => {
  ...
  return (
    <Popup
          open={isOpenUpdatedPopup}
          onClose={closeUpdatadPopup}
          modal
          nested
    ...
    <div className="login-popup">
      {!isOtpSent ? (
        <form onSubmit={handleSendOtp} className="login-popup-content">
          <input
            name="email"
            type="email"
